...
cf us retailonline redis-cache
cf us retailonline vault-store
cf us retailonline config-server
cf us retailonline PBI1451

REM ===============================================================

cf us retailonlineservice vault-store
cf us retailonlineservice config-server
...
cf delete retailonline
cf delete retailonlineservice
